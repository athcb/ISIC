...
from build_model import build_model_phase1, build_model_phase2, build_model_phase3, build_model_phase4
...
def randomised_search_tl(train_paths, param_grid_tl, num_iter, cvfolds, batch_size, oversampling_factor):
    ...
    for itr in range(num_iter):
        ...
        for i, (train_index, val_index) in enumerate(skf.split(range_train_labels, train_labels)):
            ...
            logger.info("Starting Phase 4 of Fine Tuning...")
            model = build_model_phase4(model,
                                       ...
                                       decay_steps=train_steps,
                                       decay_rate=params["decay_rate"],
                                       lr_scaling_factor_phase4=params["lr_scaling_factor_phase4"],
                                       pretrained_model=params["pretrained_model"])
