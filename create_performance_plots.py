...
def create_performance_plots(input_history_vals1, input_history_vals2, input_history_vals3):
    ...
    history_total = pd.concat([history_vals1] + [history_vals2] + [history_vals3], ignore_index=True)
    # print(history_total)
